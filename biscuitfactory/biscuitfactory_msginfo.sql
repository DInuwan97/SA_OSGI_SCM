...
CREATE TABLE `msginfo` (
  ...
  `addedDate` varchar(200) DEFAULT NULL,
  `addedTime` varchar(200) DEFAULT NULL,
  `demandConfirm` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`msgId`)
...
INSERT INTO `msginfo` VALUES (2,4,'I want CURRY Puff','2020-03-20','13:08:00','Pending');
