...
public class TransportationGui {
	 ...
	 */
	public void excecuteMain(TransportationVehicle transportationVehicle) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TransportationGui window = new TransportationGui(transportationVehicle);
	 ...
	 * @throws Exception 
	 */
	public TransportationGui(TransportationVehicle transportationVehicle) throws Exception {
		initialize(transportationVehicle);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(TransportationVehicle transportationVehicle) throws Exception{
		frame = new JFrame();
		...
		btnaddnewvehicle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(x == 0) {
					...
					boolean result = transportationVehicle.addNewVehicel(tmdeol);
					if(result == true) {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(x == 0) {
					boolean r = transportationVehicle.removeVehicle(txtvehiclenumber.getText().toString());	
					if(r == true) {
						JOptionPane.showMessageDialog(null,"Success!!!");
						reset(); 
					}else {
		...
		btnCheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				txtavailable.setText(String.valueOf(transportationVehicle.getVehicleCount()));
				List avaialble = transportationVehicle.getAvailableVehicle();
		...
		lblCheckVehicleAvailabilty.setBounds(650, 41, 524, 49);
