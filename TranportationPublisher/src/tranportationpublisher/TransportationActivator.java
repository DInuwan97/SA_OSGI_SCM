...
public class TransportationActivator implements BundleActivator {
	...
	ServiceReference serviceRefernceRawMaterial;
	...
	public void start(BundleContext context) throws Exception {
		...
		//Raw Material refernce
		//serviceRefernceRawMaterial = context.getServiceReference(RawMaterial.class.getName());
		//RawMaterial db = (IDB)context.getService(serviceRefernceRawMaterial);
